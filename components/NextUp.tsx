...
import { coverFor, type Article } from '@/lib/content';
          ...
          <li key={article.slug}>
            ...
            >
              <img
                ...
                height={700}
                loading="lazy"
                className="aspect-square w-14 shrink-0 rounded-lg object-cover object-left"
              />
              <span className="line-clamp-2 min-w-0 font-bold leading-snug text-slate-900 group-hover:text-brand-700 dark:text-white dark:group-hover:text-brand-400">
                {article.title}
              </span>
            </Link>
          </li>
