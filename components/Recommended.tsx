 ...
 *   .rounded-16         16px radius on the thumbnail — overridden to the site's
 *                       own 8px, per the brief
 *   .card-recommend img square artwork, capped at 280px tall
 *   h6.mt-3             18px semi-bold title, 16px below the image, clamped to
 *                       two lines so the cards' baselines stay aligned
