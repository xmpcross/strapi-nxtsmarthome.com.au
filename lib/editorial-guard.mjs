 ...
 * search, related posts or the sitemap, and its page 404s. `[VERIFY` is the
...
export const EDITORIAL_MARKERS = [
  ...
  // Upper case only: "todo" and "tbd" in running prose are not markers.
  { label: 'TODO', re: /\bTODO\b/g },
  { label: 'TBD', re: /\bTBD\b/g },
  { label: 'lorem', re: /\blorem\b/gi },
