...
date: '2026-07-09'
updated: '2026-08-01'
keyTakeaway: 'Almost everything worth having works in a rental. Stick to plug-in devices, screw-in bulbs, adhesive-mounted battery sensors and cameras, and you can build a genuinely capable smart home that packs into a box on moving day.'
tags:
  - Renting
  - Beginners
  - Buying advice
faq:
  - q: Can I install a smart lock in a rental?
    a: Usually not without the owner's permission, since it modifies the door hardware. Some retrofit smart locks fit over the existing internal deadlatch without altering the external hardware or the keyway, which is a much easier conversation to have with a property manager — and fully reversible.
  - q: Will smart bulbs damage the light fittings?
    a: No. Screwing in a globe is not a modification, and swapping it back when you leave takes a minute. Just check whether your fittings are B22 bayonet or E27 screw before buying, and keep the original globes in a box.
  - q: Can I put up cameras?
    a: Battery cameras with adhesive or freestanding mounts need no permission for the installation itself. Anything requiring drilling does. Be aware that the surveillance rules about what you may record apply the same as anywhere, and in an apartment you also need to consider common property.
  - q: What about the router — can I replace the one my landlord supplied?
    a: If the internet service is in your name, the router is generally yours to change. Keep the original if it was supplied with the property, and put it back when you leave. A better router is often the highest-impact smart home upgrade a renter can make.
---
