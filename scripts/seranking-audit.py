#!/usr/bin/env python3
"""
SE Ranking Technical SEO Audit & Automation helper for nxtsmarthome.com.au.
Integrates with /opt/seranking to monitor, inspect, and trigger audits for Audit ID 414163.
"""
import sys
import os
...
def main():
    ...
    if action == 'recheck':
        ...
        print(f"Triggering SE Ranking audit crawl ({mode}) for nxtsmarthome.com.au (Audit ID: {AUDIT_ID})...")
